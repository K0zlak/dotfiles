...
" " WORDCOLUMN MAPPING
omap iCw <Plug>(textobj-wordcolumn-WORD-i)
xmap iCw <Plug>(textobj-wordcolumn-WORD-i)
omap aCw <Plug>(textobj-wordcolumn-WORD-a)
xmap aCw <Plug>(textobj-wordcolumn-WORD-a)
omap icw <Plug>(textobj-wordcolumn-word-i)
xmap icw <Plug>(textobj-wordcolumn-word-i)
omap acw <Plug>(textobj-wordcolumn-word-a)
xmap acw <Plug>(textobj-wordcolumn-word-a)
